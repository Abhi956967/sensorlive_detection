...
#     try:
#         # Load full CSV
#         df = pd.read_csv("C:/Users/ABHISHEK MAURYA/sensorlive/aps_failure_training_set1.csv")
...
#         with open("sensor/artifacts/train_columns.txt", "r") as f:
...
#         # Return response
#         return df[['predicted_column']].to_dict(orient='records')
